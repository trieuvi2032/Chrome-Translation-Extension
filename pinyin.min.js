!(function (n, i) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    : i(
        ((n =
          "undefined" != typeof globalThis ? globalThis : n || self).pinyinPro =
          {})
      );
})(this, function (n) {
  "use strict";
  ...
  function o(n) {
    ...
    return (
      n.length -
      ((null === (i = n.match(h)) || void 0 === i ? void 0 : i.length) || 0)
    );
  }
  function z(n) {
    const h = [];
  ...
  function $(n, i) {
    return n &&
      (n.decimal < i.decimal ||
        (n.decimal === i.decimal && n.probability > i.probability))
      ? n
      : i;
  }
  function D(n) {
    ...
    W = new (class {
      ...
      insertPattern(n, i) {
        for (let g = n.length - 1; g >= 0; g--) {
          const h = n[g];
          if (i.priority === h.priority && i.probability >= h.probability)
            n[g + 1] = h;
          else {
        ...
        for (let n = 0; n < u.length; n++) {
          ...
          if (null === g) g = this.root;
            ...
            const u = g.patterns.find((g) =>
              "off" === i
                ? g.priority !== s.Surname
                : "head" !== i || g.length - 1 - n == 0
            );
            u &&
              h.push(
                Object.assign(Object.assign({}, u), { index: n - u.length + 1 })
              );
            let z = g.fail;
            for (; null !== z; ) {
        ...
        return 1 === g
          ? (function (n) {
              ...
              for (let u = n.length - 1; u >= 0; ) {
                ...
                for (
                  ...
                  o--;
                (o < 0 || n[o].index + n[o].length <= s) && i.push(n[u]),
                  (u = o);
              }
              var g, h;
              return i.reverse();
          ...
          ? (function (n, i) {
              ...
              let h = n.length - 1,
                u = n[h];
              for (let s = i - 1; s >= 0; s--) {
                const o = s + 1 >= i ? { count: 0, patterns: [] } : g[s + 1];
                ...
                const z = { count: 1 + o.count, patterns: o.patterns };
                (g[s] = N(g[s], z)),
                  g[s].concatPattern &&
      ...
      z(h).forEach((n, h) => {
        ...
        "replace" === g || ("add" === g && !i.get(n) && !l.get(n))
          ...
          : (i.set(n, i.get(n) || l.get(n)),
            i.get(n).split(" ").includes(s) ||
              i.set(n, `${i.get(n)} ${s}`.trim()));
      });
    }
  }
  const G = () => Q;
      ...
      for (let n of i)
        for (let i of c)
          if (n.startsWith(i)) {
            ...
            -1 !== j.indexOf(i) && -1 !== d.indexOf(u) && (u = e[u]),
              g.push(i),
              h.push(u);
            break;
          }
      return { final: h.join(" "), initial: g.join(" ") };
    },
    nn = (n) => {
      const { final: i } = Y(n);
      let g = "",
  ...
  const on = (n, i) => {
      let g = i.nonZh;
      if ("removed" === g)
        return n.filter((n) => n.isZh || !sn(n.origin, i.nonZhScope));
      if ("consecutive" === g) {
    ...
    zn = (n, i) =>
      ...
      ((n, i = "off") => {
        let g = X(n, i);
        return g.length > 0
          ? g.map((i) => ({ origin: n, result: i, isZh: !0, originPinyin: i }))
          : [{ origin: n, result: n, isZh: !1, originPinyin: n }];
      })(n, i.surname),
    tn = (n, i) => {
      switch (i.pattern) {
        case "pinyin":
  ...
  function dn(n, i) {
    ...
    void 0 === i.surname &&
      ("surname" === i.mode ? (i.surname = "all") : (i.surname = "off")),
        ...
        return "array" === i.type
          ...
          ? n.map((n) => {
              ...
              return (
                "" !== g &&
                  (t = [g].concat(
                    X(n.origin, i.surname).filter((n) => n !== g)
                  )),
                {
                  origin: n.origin,
                  pinyin: g,
  ...
  const xn = {
    ...
    pn = (n, i, g) => {
      ...
      return (
        "ignore" === g.space && (h = h.filter((n) => " " !== u[n])),
        h.length ? h : null
      );
    },
    wn = (n, i, g) => {
        ...
        for (let s = 1; s <= i.length; s++)
          if (u[n - 1][s - 1] && (1 === s || u[n - 1][s - 1].length)) {
            ...
            if (h[n - 1] === i[s - 1]) {
              ...
              if (
                ((!u[n][s] || g.length > u[n][s].length) && (u[n][s] = g),
                s === i.length)
              )
                return u[n][s];
            }
              ...
              if (
                o.some((n) =>
                  "any" === g.lastPrecision
                    ...
                    : "every" === g.lastPrecision &&
                      n === i.slice(s - 1, i.length)
                )
              )
              ...
              ("start" === z &&
                o.forEach((g) => {
                  ...
                  for (; h <= i.length && g.startsWith(i.slice(s - 1, h)); )
                    (!u[n][h] || o.length > u[n][h].length) && (u[n][h] = o),
                      h++;
                }),
  ...
  const an = (n) =>
      z(n).map((n) => {
        ...
        return { origin: n, result: i, isZh: i !== n, originPinyin: i };
      }),
    kn = (n) =>
      n.map((n) =>
        n.isZh
    ...
    Sn = { separator: " ", format: "numToSymbol" },
    Zn = {
      a: ["a", "ā", "á", "ǎ", "à"],
      o: ["o", "ō", "ó", "ǒ", "ò"],
      e: ["e", "ē", "é", "ě", "è"],
  ...
  (n.OutputFormat = void 0),
    ((On = n.OutputFormat || (n.OutputFormat = {}))[(On.AllSegment = 1)] =
      "AllSegment"),
  ...
  (n.addDict = function (n, i) {
          ...
          return "numToSymbol" === g
            ? (function (n) {
                ...
                if (i >= 0 && i <= 4) {
                  for (let g in Zn)
                    if (n.includes(g))
                      return n.slice(0, n.length - 1).replace(g, Zn[g][i]);
                  return n;
                }
                return n;
              })(n)
      ...
      return dn(n, {
        ...
        .map((n) => {
          ...
          if (n.isZh) {
            ...
            return `<span class="${h}${i}"><ruby><span class="${u}">${
              n.origin
            }</span>${g.rp ? "<rp>(</rp>" : ""}<rt class="${s}">${
              n.pinyin
            }</rt>${g.rp ? "<rp>)</rp>" : ""}</ruby></span>`;
          }
          if (g.wrapNonChinese) {
            return `<span class="${
              g.nonChineseClass || fn.nonChineseClass
            }${i}">${n.origin}</span>`;
          }
          return n.origin;
        })
    ...
    (n.match = (n, i, g) => {
      ...
      return (function (n, i) {
        ...
        n,
        "any" === (null == g ? void 0 : g.precision) ? pn(n, i, h) : wn(n, i, h)
      );
    }),
    (n.pinyin = dn),
    ...
    (n.segment = function (i, g) {
      if (((g = Object.assign(Object.assign({}, Pn), g || {})), !un(i)))
        return i;
      void 0 === g.surname &&
        ("surname" === g.mode ? (g.surname = "all") : (g.surname = "off"));
      let h = Array(o(i)),
      ...
      const t = (function (n, i) {
        ...
        for (; h < n.length && u < i.length; ) {
          ...
          if (s.zh.startsWith(o.origin)) {
            ...
            const y = n.slice(i, t);
            g.push({
              segment: y.map((n) => ({ origin: n.origin, result: n.result })),
              isZh: !0,
            }),
              (h += t - i),
              u++;
            ...
            g.push({
              segment: [{ origin: o.origin, result: o.result }],
              isZh: !1,
            }),
              h++;
        }
        for (; h < n.length; ) {
          const i = n[h];
          g.push({
            segment: [{ origin: i.origin, result: i.result }],
            isZh: !1,
          }),
            h++;
        }
